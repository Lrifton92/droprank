// AUTO-GENERATED from contracts/artifacts/src/DropRankBadge.sol/DropRankBadge.json
// Regenerate after contract changes. Do not hand-edit the ABI below.
//
// Soulbound DropRank badge (ERC-721) deployed on Base.

/** Chain ids where the badge can live. */
...
export const DROPRANK_BADGE_ADDRESS: Record<number, `0x${string}`> = {
  ...
  [BASE_SEPOLIA_CHAIN_ID]: '0x0000000000000000000000000000000000000000',
};

/** EIP-712 typed-data domain (must match the contract constructor). */
export const DROPRANK_EIP712_DOMAIN = {
  name: 'DropRank',
  version: '1',
} as const;

/** EIP-712 types for the score attestation signed by the backend signer. */
export const SCORE_ATTESTATION_TYPES = {
  ScoreAttestation: [
...
export const DROPRANK_BADGE_ABI = [
  {
    "inputs": [
      {
